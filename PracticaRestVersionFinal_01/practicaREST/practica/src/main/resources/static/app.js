var game = new Phaser.Game(1920, 1080, Phaser.AUTO, 'phaser', {preload: preload, create: create, update: update});
...
function preload() {
    ...
    game.load.image('vaj', 'volver.png')
...
function generarjugadores(play)
{
   ...
   /* loadItem();*/
    ...
    window.open("http://localhost:8090/index2.html","_self");
    play.destroy();
...
function update()
{
...

    {
        ...
        vaj.events.onInputOver.add(alfachangeplay, this)
        vaj.events.onInputDown.add(jugardenuevo, this);
        vaj.events.onInputOut.add(alfachangeplay2, this);
...
function createItem(NuevaPuntuacion) {
    $.ajax({
        method: "POST",
